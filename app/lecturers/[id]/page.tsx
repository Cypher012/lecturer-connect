...
export default function LecturerProfilePage({ params }: LecturerProfilePageProps) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-start space-y-6 lg:space-y-0 lg:space-x-8">
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg text-accent font-medium mb-4">{lecturer.department}</p>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-2">
                      {lecturer.research_areas.map((area) => (
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {lecturer.courses_taught.map((course) => (
                      <Card key={course} className="border-l-4 border-l-accent">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {lecturer.projects.map((project, index) => (
                      <Card key={index} className="border-l-4 border-l-accent">
                        <CardContent className="p-4">
                          <h3 className="font-semibold text-foreground mb-2">{project}</h3>
                          <p className="text-sm text-muted-foreground">
                            Ongoing research project focusing on innovative solutions and practical applications.
                          </p>
                        </CardContent>
                      </Card>
                    ))}
